...
//                textAlign = TextAlign.Center,
        ...
        Row(
            ...
            Image(
                painterResource(R.drawable.micky), contentDescription = null,
        ...
        Column(
            ...
            Text("Micky Mousy", style = TextStyle(
                fontWeight = FontWeight.Bold, color = Color.Black))
            Text("Artist", modifier = Modifier.alpha(alpha = 0.5f))
            Text("Designer")
            Text("micky@art.com")
            Text("Followed by Donald The Duck and Goofy")
        }
